...
SPIBASE 		= 0xBD400000					# Base addr of SPI Flash read addr, not CRs addr!
LOADADDR 		= 0xBFC00000					# Bootloader load address
RAM_LOADADDR 	= 0x80200000					# Binary file memory load address
								
RAMSIZE 		= 0x07000000					# 128M - 16M / 16M GRAM (Reserved)
